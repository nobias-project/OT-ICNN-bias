...
if args.optimizer is 'SGD':
    results_save_path = '../results/Results_CelebA_Toy_Hist/input_dim_{5}/init_{6}/layers_{0}/neuron_{1}/lambda_cvx_{10}_mean_{11}/optim_{8}lr_{2}momen_{7}/gen_{9}/batch_{3}/trial_{4}_last_{12}_qudr'.format(
    ...
    results_save_path = '../results/Results_CelebA_Toy_Hist/input_dim_{5}/init_{6}/layers_{0}/neuron_{1}/lambda_cvx_{11}_mean_{12}/optim_{9}lr_{2}betas_{7}_{8}/gen_{10}/batch_{3}/trial_{4}_last_{13}_qudr'.format(
...
X_data = torch.load("../data/celeba/celebA__hist_sample2.pt").reshape((-1,256*3))
Y_data = torch.load("../data/celeba/celebA__hist_sample1.pt").reshape((-1,256*3))
