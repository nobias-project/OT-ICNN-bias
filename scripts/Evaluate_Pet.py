...
convex_f = Simple_Feedforward_3Layer_ICNN_LastFull_Quadratic(2048,
                                                             512,
                                                             "leaky_relu")
...
convex_g = Simple_Feedforward_3Layer_ICNN_LastFull_Quadratic(2048,
                                                             512,
                                                             "leaky_relu")
...
path_csv = ("../results/Results_Pet_resnet50/"
            "convex_f_{}_results.csv".format(args.epoch))
