...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 09:28:21 2022
...
parser = argparse.ArgumentParser(description='PyTorch CelebA Toy Beard Experiment')
...
# parser.add_argument('--gpus', default=3, help='gpus used for training - e.g 0,1,3')
...
if args.optimizer =='SGD':
    results_save_path = '../results/Results_CelebA_Toy_Beard/input_dim_{5}/init_{6}/layers_{0}/neuron_{1}/lambda_cvx_{10}_mean_{11}/optim_{8}lr_{2}momen_{7}/gen_{9}/batch_{3}/trial_{4}_last_{12}_qudr'.format(
    ...
    results_save_path = '../results/Results_CelebA_Toy_Beard/input_dim_{5}/init_{6}/layers_{0}/neuron_{1}/lambda_cvx_{11}_mean_{12}/optim_{9}lr_{2}betas_{7}_{8}/gen_{10}/batch_{3}/trial_{4}_last_{13}_qudr'.format(
...
plt.plot(range(10, len(total_w_2_epoch_loss_list) + 1), total_w_2_epoch_loss_list[9:], label='Training loss')
plt.xlabel('iterations')
plt.ylabel(r'$W_2$-loss value')
